...
if __name__ == "__main__":
    ...
    alipay = AliPay(
        appid="2016081500252288",
        app_notify_url="http://47.94.172.250:8804/api/v1/trade/alipay/",
        return_url="http://47.94.172.250:8804/api/v1/trade/alipay/",
        app_private_key_path="./app_private_2048.txt",
        alipay_public_key_path="./alipay_public_2048.txt",  # 支付宝的公钥，验证支付宝回传消息使用，不是你自己的公钥,
        debug=True,  # 默认False,
    )
